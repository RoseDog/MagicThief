...
public class GoldPoper : MonoBehaviour 
{    
    public Chest chest;    
	...
	public void InitParticleTex(int gold)
	{
		...
		for (int i = 0; i < 3; ++i )
		{
			systems[i].gameObject.SetActiveRecursively(false);
		}
        ...
        for (int i = 0; i < value.Length; ++i)
        {
            ...
            systems[i].renderer.material.mainTexture = (Texture2D)Resources.Load("Effects/GoldPoper/" + digit, typeof(Texture2D));
        }
	}
